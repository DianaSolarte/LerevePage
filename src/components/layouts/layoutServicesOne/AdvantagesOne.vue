<template>
  <div class="container mx-auto py-12 px-4">
    <div class="text-center mb-12">
      <h3 class="text-sm text-black-500 mb-2 text-left">Soluciones de planificación financiera</h3>
    ...
    <div class="flex flex-col space-y-8 sm:space-y-0 sm:grid sm:grid-cols-2 lg:grid-cols-3 sm:gap-8">
      ...
      <div class="flex items-start">
        ...
        <div>
          <h3 class="text-lg font-semibold text-left">Estructura legal</h3>
      ...
      <div class="flex items-start">
        <span class="text-blue-500 text-2xl font-bold mr-4">✓</span>
        <div>
          <h3 class="text-lg font-semibold text-left">Acuerdos, Sucesiones, Conflictos</h3>
      ...
      <div class="flex items-start">
        <span class="text-blue-500 text-2xl font-bold mr-4">✓</span>
        <div>
          <h3 class="text-lg font-semibold text-left">Gobierno corporativo</h3>
      ...
      <div class="flex items-start">
        <span class="text-blue-500 text-2xl font-bold mr-4">✓</span>
        <div>
          <h3 class="text-lg font-semibold text-left">Organización y eficiencia entre familia y patrimonio.</h3>
