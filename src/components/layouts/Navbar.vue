<template>
    <header class="nabvar rounded-full">
        <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">Le Reve</span>
            <img class="h-8 w-auto" src="/src/assets/LeReve.svg" alt="" />
            </a>
        </div>
        <div class="flex lg:hidden">
            <button type="button" class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-white-700" @click="mobileMenuOpen = true">
            ...
            <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
                ...
                <div class="p-4">
                    ...
                    <div class="flex-auto">
                        ...
                        <p class="mt-1 text-white-600">{{ item.description }}</p>
                    </div>
                    </div>
                </div>
        ...
        <div class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded hidden lg:flex lg:justify-end">
            <a href="#" class="text-sm font-semibold leading-6 text-white-900"> Contactenos <span aria-hidden="true">&rarr;</span></a>
        </div>
        </nav>
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            <div class="-my-6 divide-y divide-gray-500/10">
                ...
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Servicios</a>
                ...
                <div class="py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Contactenos</a>
                </div>
            </div>
            </div>
        </DialogPanel>
...
const products = [
    { name: 'Planificación financiera', description: 'Planificación financiera' , href: '#',/* icon: ChartPieIcon  */}, 
    { name: 'Sistemas de gestión', description: 'Sistemas de gestión', href: '#'/* , icon: CursorArrowRaysIcon  */},
    { name: 'Sistemas de inversión', description: 'Sistemas de inversión', href: '#'/* , icon: FingerPrintIcon  */},
    { name: 'Servicios inmobiliarios', description: 'Servicios inmobiliarios', href: '#'/* , icon: SquaresPlusIcon  */},
    { name: 'Gestión de riesgos', description: 'Gestión de riesgos', href: '#'/* , icon: ArrowPathIcon  */},
    { name: 'Auditoria financiera y de procesos', description: 'Auditoria financiera y de procesos', href: '#'/* , icon: ArrowPathIcon  */},
]
/* const callsToAction = [
