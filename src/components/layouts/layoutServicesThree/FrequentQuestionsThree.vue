  ...
  data() {
    return {
      faqs: [
        ...
        {
          question: '¿Cuál es el papel de la familia en la administración del family office?',
          answer: 'XXXX',
          showAnswer: false,
        },
