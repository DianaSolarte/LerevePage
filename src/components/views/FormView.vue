<template>
  <div class="formdiv relative min-h-screen bg-[#F9FAEF]">
    ...
    <div class="w-full px-4 py-12">
      <p>Contáctenos hoy para comenzar</p>
      ...
      <form @submit.prevent="submitForm" class="space-y-8">
        <div class="relative">
          ...
          <input type="text" id="nombre" v-model="formData.nombre" :class="{'border-red-500': errors.nombre, 'border-gray-300': !errors.nombre}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm rounded-md bg-gray-100">
      ...
      <p class="mt-8 text-left">Llámanos: +57 (601) 612-8418<br>Escríbenos: servicioalcliente@lereve.com.co<br>Encuéntranos: Bogotá, Cr 7 Bis 124-26 Colombia.</p>
      <p class="mt-8 text-left text-gray-900">Todos los campos son obligatorios. Al enviar el formulario, aceptas los Términos y Condiciones y la Política de Privacidad.</p>
    </div>
  ...
  methods: {
    ...
    submitForm() {
      if (this.validateForm()) {
        ...
        emailjs.send('service_8g6zvgt', 'template_phnq5f6', this.formData, '2JsIy8w7wJmlL3Y6s')
          .then((response) => {
